...
def _debug_read(camera, cam_dir ='cam1', save_datastream=False):
...
if __name__ == "__main__":
    ...
    im = rs.read()
    _debug_read(rs, 'cam1', save_datastream=True)
    ...
    #     server1_thread = threading.Thread(target=_debug_read, args=(rs1, True, 'cam1'))
